...
class ProjectSuggestionThumbnail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      projects: []
  ...
  render() {
    ...
    return (
      <section id="ProjectSuggestionThumbnail">
        <h2 className="h2">Most liked projects</h2>
...
export default ProjectSuggestionThumbnail;
